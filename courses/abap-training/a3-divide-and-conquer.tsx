...
ENDFORM.`}
              ...
              <Dialog speaker="b">
                二分探索やマージソートは「自分自身をもう一度呼ぶ」感じがしました。これも分割統治と関係ありますか？
              </Dialog>
              <Dialog speaker="teacher">
                あります。小問題が<strong>同じ形</strong>をしているとき、同じ手順を自分自身にもう一度あてはめることがあり、
                これを<strong>「再帰」</strong>と呼びます。ただし ABAP の実務帳票では <code>FORM</code> で役割ごとに分ける形が中心なので、
                今は再帰を怖がらなくて大丈夫です。
              </Dialog>
              <LessonLinkButton
