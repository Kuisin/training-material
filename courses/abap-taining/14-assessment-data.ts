...
export const ASSESSMENTS: LessonAssessmentData[] = [
  ...
  },
  {
    num: "13",
    title: "良いABAP",
    summary: "性能の良い SELECT の書き方を確認します。",
    arrangeKind: "code",
    ...
    quizzes: [
      ...
      },
      {
        ...
        options: [
          ...
          "FOR ALL ENTRIES や JOIN でまとめて取得する",
        ],
        answers: [0, 2, 3],
        explanation: "必要列・一括取得・JOIN/FOR ALL ENTRIES が基本です。",
      },
      {
        level: "advanced",
        ...
        options: [
          ...
          "件数が多い場合の出力件数制限やページング",
        ],
        answers: [0, 1, 3],
        explanation:
          "キー・DB アクセス回数・出力制御を総合的に設計します。",
      },
    ],
  },
];
